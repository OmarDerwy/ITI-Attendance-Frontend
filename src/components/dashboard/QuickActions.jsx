      ...
      return (
        <Dialog>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              className="w-full h-24 flex flex-col items-center justify-center gap-2 bg-white hover:bg-purple-50 border-purple-200"
            >
      ...
      <CardContent>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <Link to="/tracks">
            <Button
              variant="outline"
              className="w-full h-24 flex flex-col items-center justify-center gap-2 bg-white hover:bg-amber-50 border-amber-200"
            >
          ...
          <Link to="/attendance-insights">
            <Button
              variant="outline"
              className="w-full h-24 flex flex-col items-center justify-center gap-2 bg-white hover:bg-emerald-50 border-emerald-200"
            >
